...
import { FieldPath, FieldValues, RegisterOptions, Validate } from 'react-hook-form';
...
export type FormFieldValidation<V extends any = any> = Record<string, Validate<V, any>>;
...
export interface FormFieldProps<F extends FieldValues = FieldValues> {
    name: FieldPath<F>;
    rules?: FormFieldRules<F> & Pick<RegisterOptions<F, FieldPath<F>>, 'required'>;
    label?: string;
    mandatory?: boolean;
